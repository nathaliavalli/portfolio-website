...
const Projects: React.FC = () => {
  const projects = [
    {
      ...
      description: "A comprehensive web application designed to support individuals with communication challenges. Features an intuitive interface for creating and sharing communication boards with multimedia support.",
      longDescription: [
      ...
      techStack: ["React", "TypeScript", "Node.js", "RESTful APIs", "Database Integration", "Agile/Scrum"],
      features: [
      ...
      image: "/projects/storyquest-preview.png", // Add project image
    ...
    },
    {
      ...
      description: "A sophisticated web application focusing on performance optimization and scalable architecture. Demonstrates advanced system design patterns and comprehensive testing strategies.",
      longDescription: [
      ...
      techStack: ["JavaScript", "Node.js", "RESTful APIs", "System Architecture", "Testing Frameworks"],
      features: [
    ...
    },
    {
      ...
      description: "A fully functional command-line shell built from scratch in C, implementing core Unix shell functionality with advanced process management and signal handling capabilities.",
      longDescription: [
      ...
      techStack: ["C Programming", "Linux/Unix", "System Calls", "Process Management", "IPC"],
      features: [
    ...
    },
    {
      ...
      description: "A comprehensive collection of mathematical modeling projects demonstrating algorithmic problem-solving and data analysis capabilities using Python and MATLAB.",
      longDescription: [
      ...
      techStack: ["Python", "MATLAB", "Algorithm Design", "Statistical Analysis", "Data Visualization"],
      features: [
      ...
      documentation: "https://github.com/nathaliavalli/matlab/blob/main/README.md",
  ...
  const categories = ["All", "Full-Stack Web Application", "System Architecture", "Systems Programming", "Mathematical Modeling"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            systems programming, and mathematical problem-solving capabilities.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-50 rounded-xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Explore additional projects, coursework, and experiments in my GitHub repositories.
            </p>
            <a
